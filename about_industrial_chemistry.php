...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="catalogs">
			...
			<div class="about_this" id="about_industrial_chemistry">
				<span>Промышленная химия</span>
				<p>Мы поставляем:</p>
				<li>Растворители.</li>
				<li>Омывающие жидкости.</li>
				<li>Читстящие жидкости.</li>
			...
			<div class="back" id="come_back"><a href="/" title="Перейти на главную">Вернуться на главную страницу</a></div>
