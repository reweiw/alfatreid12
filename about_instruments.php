...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="catalogs">
			...
			<div class="about_this" id="about_instruments">
				<span>Инструменты</span>
				<p>Мы поставляем:</p>
				<ul>
					<li>Электроинструмент.</li>
					<li>Ручной инструмент:
						<ul>
							<li>для транспортировки грузов;</li>
							<li>для земляных работ;</li>
							<li>для слесарно-монтажных работ;</li>
							<li>инструменты для сварки;</li>
							<li>для отделочных и кладочных работ;</li>
							<li>плотницкий и столярный инструмент;</li>
							<li>измерительные приборы и приспособления.</li>
						</ul>
					</li>
					<li>Расходные материалы для обработки поверхностей.</li>
				</ul>
				<p>Помимо инструментов мы можем предложить: ящики, тележки, стенды и органайзеры для хранения.</p>
